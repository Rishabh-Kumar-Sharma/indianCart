...
const Slug = ({ buyNow, addToCart, product, variants, error }) => {
  ...
  const [servicablity, setServicablity] = useState();
  const onChangePin = (e) => {
  ...
  const checkServicablity = async () => {
    ...
    if (Object.keys(pinJson).includes(pin)) {
      ...
      toast.error("Sorry your Pin Code is not servicable", {
        position: "bottom-center",
        autoClose: 1000,
        hideProgressBar: true,
        closeOnClick: true,
  ...
  if (error === 404) return <Error statusCode={error} />;
  return (
    <>
      <Head>
        <title>CodesWear | Products</title>
      </Head>
      <section className="text-gray-600 body-font overflow-hidden">
        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full px-24 md:px-0 lg:h-auto object-cover object-top rounded"
              src={product.img}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">
                {/* {product.title}({product.size}/{`${product.color}`.toUpperCase()}) */}
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="disabled:bg-pink-300 flex ml-6 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Add to Cart
                </button>
                <button
              ...
              <div className="pin mt-6 flex space-x-2">
                <input
                  ...
                  className="px-2{ ${}`border-2 border-brown"
                />
                <button
                  onClick={checkServicablity}
                  className="flex ml-6 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 r ${}`ounded"
                >
                  Verify the pincode
                </button>
              </div>
              {!servicablity && servicablity != null && (
